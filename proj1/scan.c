...
typedef enum
{ START,INASSIGN,INCOMMENT,INLINE,INSTAR,INNUM,INID,INEQ,INNE,INLT,INGT,INOVER,DONE }
StateType;
...
{ char* str;
    ...
    {"write",WRITE}},{"int",INT},{"return",RETURN},{"void",VOID},{"while",WHILE};
